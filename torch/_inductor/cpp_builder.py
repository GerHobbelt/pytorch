...
def _get_libstdcxx_args(cpp_compiler: str) -> tuple[list[str], list[str], list[str]]:
    """
...
def get_cpp_torch_options(
    ...
    ldflags = omp_ldflags
    libraries_dirs = python_libraries_dirs + torch_libraries_dirs + omp_lib_dir_paths + stdcxx_lib_dir_paths
